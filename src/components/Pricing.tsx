    ...
    <section id="pricing" style={{ background: "var(--surface-1)" }} className="py-28 px-6">
      <div className="max-w-6xl mx-auto">
            ...
            return (
              <div
                ...
                style={{
                  ...
                  boxShadow: plan.highlighted ? `0 0 0 1px ${plan.accentBorder}, 0 24px 60px rgba(92,110,248,0.12)` : "none",
                }}
              >
                {/* Popular badge */}
                {plan.highlighted && (
        ...
        <p className="text-center text-sm mt-10" style={{ color: "var(--text-3)" }}>
          ...
          <a href="/auth/signup" style={{ color: "var(--brand)" }} className="hover:underline">Let's talk.</a>
        </p>
      </div>
    </section>
  );
